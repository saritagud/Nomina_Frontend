function EditInforUser({ dataEdit, setDataEdit, user, setUser, setEditMode }) {
  ...
  const handleSubmit = () => {
    ...
    if (dataEdit.name === '') return console.error('El campo Nombre no puede estar vacio')
    if (dataEdit.phone === '') return console.error('El campo Telefono no puede estar vacio')
    if (dataEdit.lastName === '') return console.error('El campo Apellido no puede estar vacio')
    if (dataEdit.address === '') return console.error('El campo Direccion no puede estar vacio')
    if (dataEdit.email === '') return console.error('El campo Email no puede estar vacio')
    if (dataEdit.email === '') return console.error('El campo Email no puede estar vacio')
    if (!emailRegex.test(dataEdit.email)) return console.error('El Email no es valido')
