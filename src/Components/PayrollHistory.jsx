      ...
      <main className="w-full flex flex-col items-center justify-center p-12 gap-10">
        ...
        <div className="flex flex-col items-center" style={{ marginLeft: '200px'}}>
          <div className="bg-blue-900 text-white px-10 py-1 rounded-md text-grisClaro font-semibold text-center mb-6 cursor-pointer" style={{ fontSize: '1.5rem' }}>
            ...
            <table className="bg-grisClaro rounded-md shadow-right-dark px-4 border-separate border-spacing-0 border-spacing-y-4">
            <thead className="px-5">
              <tr>
                <th className="p-4 text-lg text-start">Nomina</th>
            ...
            <tbody>
              {payrollsOpen.map((payroll) => (
                <tr key={payroll.id} className="bg-grisOscuro">
                  <td className="p-4 text-lg rounded-l-2xl">{payroll.name}</td>
